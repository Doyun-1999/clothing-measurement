                    ...
                    child: Stack(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            IconButton(
                                padding: EdgeInsets.only(bottom: 10), // 패딩을 줄입니다.
                                onPressed: () {
                                  setState(() {
      ...
      child: SingleChildScrollView(
        child: Stack(
          children: [
            Column(
              ...
              children: [
                ...
                Container(
                  height: 200,
                  decoration:
                  BoxDecoration(border: Border.all(width: 1, color:
                  Colors.grey)),
                  constraints:
            ...
            Consumer<ServiceProvider>(builder:
            ((context, value, child) {
